...
export const textArray2 = [
    ...
    {
        content : `당일 18시에 총학생회 측에서 ${space} 인스타그램 스토리를 언급 순서대로 리그램(하루 동안 하이라이트에 게시)`,
        width : 265,
        height : 72,
    }, 
    {
        content : `총학생회 인스타그램에 리그램된 ${space} 스토리 중 하트를 많이 받은 순으로 ${space2} 등수 확인 (24시간동안 진행, 동일한 하트를 받을 시 해당 학우들의 동의 ${space3} 하에 인스타그램에서 투표진행)`,
        width: 274.113,
        height: 120,
    }, 
    {
        content : `행사 종료 이후, 인스타그램 스토리 ${space5} 좋아요수 확인을 하며, 베스트 드레서 ${space4} 발표는 사진과 함께 업로드`,
        width : 278,
        height : 80,
    }
];