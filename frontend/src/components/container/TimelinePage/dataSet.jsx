...
export const datas1 = [
  {
    ...
    },
    {
      ...
      content2 : `18살 때부터 기타를 배운 영향인지 기타 ${space} 수집을 하는데 어느 정도 많아진다 싶으면 당근을 통해 판매한 적도 있다고 한다.`
    },
    {
      id : 3,
      url : leeSeungYoon,
      ...
      kor : '이승윤',
      eng : 'Lee seung yoon',
      content1 : '오디션 프로그램 싱어게인에 30호 가수로 출연해서 [소우주], [Honey], [연극 속에서] 등을 부르며 최종 우승을 차지했다.',
    ...
    },
    {
      ...
      kor : '10cm',
      eng : '',
      content1 : `[부동의 첫사랑], [봄이좋냐?], [그라데이션] 등의 대표곡을 포함해 수많은 히트곡을 ${space} 보유한 대한민국의 가수이다`,
      content2 : `사실 공연에서만 들을 수 있는, 앨범화가  ${space} 되지 않은 노래들이 많다. 이유는 녹음하기 귀찮아서···.`
    }
  ];
  ...
  export const datas2 = [
    ...
    },
    {
      ...
      content2 : `팀명은 모험을 의미하는 Adventure의 ${space + space} 약자인 'AD'와 스페인어로 출발을 의미하는 'YA'가 합쳐진 팀명이다.`
    },
    {
      id : 2,
      url : Kassy,
